...
export default function Home() {
  return (
    <main className="relative container md:px-16 lg:px-32 mx-auto flex justify-center flex-col text-center">
      <div className="background fixed inset-0 h-screen w-screen z-[-1]" />
      ...
      {texts.map((text, index) => (
        <p
          ...
          className={`flex items-center justify-center px-8 h-[50vh] ${
            text.length > 4 ? 'text-5xl md:text-7xl' : 'text-7xl md:text-9xl'
          }`}
        >
          {text}
        </p>
      ...
      <div className="flex flex-col items-center justify-center h-screen">
        <p className="text-4xl md:text-5xl p-8">
